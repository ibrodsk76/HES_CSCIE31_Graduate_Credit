...
This topic can cause a lot of confusion. Even when I thought I understood the difference between synchronous and asynchronous calls and understod the syntax of callbacks, promises, and awaits, I often found myself getting unexpected results when it came to the order the commands were executed. Completing this exercise helped me to understand this topic much better.
